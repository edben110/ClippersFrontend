    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'fixed z-50 grid w-full gap-3 sm:gap-4 rounded-lg border shadow-lg duration-200',
          'max-w-[calc(100vw-1rem)] max-h-[calc(100vh-1rem)] sm:max-w-[calc(100vw-2rem)] sm:max-h-[calc(100vh-2rem)]',
