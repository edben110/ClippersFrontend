...
export function EditEducationModal({ education, open, onOpenChange }: EditEducationModalProps) {
  ...
  useEffect(() => {
    if (education) {
      ...
      setIsCurrentStudy(!education.endDate)
    }
  }, [education])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Tu información educativa ha sido actualizada exitosamente.",
      })
